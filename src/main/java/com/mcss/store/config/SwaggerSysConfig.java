...
public class SwaggerSysConfig {
     ...
     */
    @Bean
    public Docket docketSys(Environment environment) {
        // 设置要显示的swagger环境
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .enable(true)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.mcss.store.sys.controller"))//扫描该包下面的API注解
